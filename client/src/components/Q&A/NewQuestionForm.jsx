  ...
  return (
    <div widgetname="Questions/Answers">
      ...
      <form onSubmit={handleSubmit} widgetname="Questions/Answers">
        <label htmlFor="question" widgetname="Questions/Answers">Question:</label><br></br>
        <textarea name="question" maxLength="1000" widgetname="Questions/Answers" required></textarea><br></br><br></br>
        <label htmlFor="user" widgetname="Questions/Answers">Username: </label><br></br>
        ...
        <label htmlFor="email" widgetname="Questions/Answers">Email:</label><br></br>
